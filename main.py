...
def banner(console):
    ...
    console.print("[bold green]♕ FB[/bold green]: ธนดล ฉวิกขุนรัมย์")
    console.print(f"[bold green]♕ กลุ่ม[/bold green]: [bold blue]@{__CHANNEL_USERNAME__}[/bold blue] or [bold blue]@{__GROUP_USERNAME__}[/bold blue].")
    console.print("[bold red]==================================================[/bold red]")
    console.print("[bold yellow]! Note[/bold yellow]: ออกจากบัญชีก่อนทำนะจ๊ะ !.", end="\n\n")
...
def load_player_data(cpm):
    ...
    if response.get('ok'):
        ...
        if 'floats' in data and 'localID' in data and 'money' in data and 'coin' in data:
            console.print("[bold][red]========[/red][ รายละเอียดผู้เล่น ][red]========[/red][/bold]")
            console.print(f"[bold green]Name   [/bold green]: { (data.get('ชื่อ') if 'Name' in data else 'UNDEFINED') }.")
            console.print(f"[bold green]LocalID[/bold green]: { (data.get('เลข ID') if 'localID' in data else 'UNDEFINED') }.")
            console.print(f"[bold green]Money  [/bold green]: { (data.get('เงิน') if 'money' in data else 'UNDEFINED') }.")
            console.print(f"[bold green]Coins  [/bold green]: { (data.get('เหรียญ') if 'coin' in data else 'UNDEFINED') }.", end="\n\n")
        else:
...
def load_key_data(cpm):
    ...
    console.print("[bold][red]========[/red][ รายละเอียดสำคัญในการเข้าถึง ][red]========[/red][/bold]")
    console.print(f"[bold green]รหัสการเข้าถึง [/bold green]: { data.get('access_key') }.")
    console.print(f"[bold green]รหัสโทรเลข[/bold green]: { data.get('telegram_id') }.")
    console.print(f"[bold green]เครดิต   [/bold green]: { (data.get('coins') if not data.get('is_unlimited') else 'Unlimited') }.", end="\n\n")
...
if __name__ == "__main__":
    ...
    while True:
        ...
        while True:
            ...
            console.print("[bold cyan](01): ปั้มเงิน M ~ 1K[/bold cyan]")
            console.print("[bold cyan](02): ปั้มเหรียญ ~ 3.5K[/bold cyan]")
            console.print("[bold cyan](03): ปั้มแรงค์คิง  ~ 4K[/bold cyan]")
            console.print("[bold cyan](04): เปลี่ยนเลข ID ~ 3.5K[/bold cyan]")
            console.print("[bold cyan](05): เปลี่ยนชื่อ ~ 100[/bold cyan]")
            console.print("[bold cyan](06): เปลี่ยนชื่อ (สีรุ้ง) ~ 100[/bold cyan]")
            console.print("[bold cyan](07): ป้ายทะเบียน ~ 2K[/bold cyan]")
            console.print("[bold cyan](08): ลบบัญชี ~ FREE[/bold cyan]")
            console.print("[bold cyan](09): ลงทะเบียนบัญชี ~ FREE[/bold cyan]")
            console.print("[bold cyan](10): ลบเพื่อน ~ 500[/bold cyan]")
            console.print("[bold cyan](11): ปลดรถเติม ~ 4K[/bold cyan]")
            console.print("[bold cyan](12): ปลดล็อครถุกคัน ~ 3K[/bold cyan]")
            console.print("[bold cyan](13): ปลดไซเรนทุกคัน ~ 2K[/bold cyan]")
            console.print("[bold cyan](14): ปลดเครื่อง 4 แสน ~ 3K[/bold cyan]")
            console.print("[bold cyan](15): ปลดแตร ~ 3K[/bold cyan]")
            console.print("[bold cyan](16): ปลดรถไม่พัง ~ 2K[/bold cyan]")
            console.print("[bold cyan](17): ปลดน้ำมันไม่หมด ~ 2K[/bold cyan]")
            console.print("[bold cyan](18): ปลดบ้าน 3 ~ 3.5K[/bold cyan]")
            console.print("[bold cyan](19): ปลดควัน ~ 2K[/bold cyan]")
            console.print("[bold cyan](20): เปลี่ยนการแข่งชนะ~ 1K[/bold cyan]")
            console.print("[bold cyan](21): เปลี่ยนการแข่งแพ้ ~ 1K[/bold cyan]")
            console.print("[bold cyan](22): โคลนบัญชี ~ 5K[/bold cyan]")
            console.print("[bold cyan](0) : ออก[/bold cyan]", end="\n\n")
